object buscar_nome: Tbuscar_nome
  Left = 185
  Top = 175
  BorderIcons = []
  BorderStyle = bsSingle
  Caption = 'SELECIONAR DIZIMISTA'
  ClientHeight = 156
  ClientWidth = 375
  Color = 16312551
  ...
  object Label1: TLabel
    ...
    Height = 16
    Alignment = taCenter
    Caption = 'Digite a Referencia / C'#243'digo de Barras'
  ...
  object Label2: TLabel
    ...
    Height = 16
    Alignment = taCenter
    Caption = 'Digite o Nome do Dizimista:'
    Font.Charset = ANSI_CHARSET
    Font.Color = clNavy
    Font.Height = -13
    Font.Name = 'MS Sans Serif'
  ...
  object qryAlunos: TIBQuery
    Database = Dados.IBDatabase
    Transaction = Dados.IBTransaction
    SQL.Strings = (
      
        'select case when (REFERENCIA is null) or (REFERENCIA = '#39#39') then ' +
        'CODIGO else REFERENCIA end as REFERENCIA,'
      
        '          case when (REFERENCIA is null) or (REFERENCIA = '#39#39') th' +
        'en 0 else 1 end as PORREFERENCIA, '
      '          NOME from TABDIZIMISTA'
      'order by 2')
    Left = 263
    Top = 66
    ...
    object qryAlunosREFERENCIA: TIBStringField
      FieldName = 'REFERENCIA'
      Origin = '"TABDIZIMISTA"."REFERENCIA"'
      Size = 10
    end
    object qryAlunosPORREFERENCIA: TIntegerField
      FieldName = 'PORREFERENCIA'
      ProviderFlags = []
    end
  end
end
