object Valor_Universal_BD: TValor_Universal_BD
  Left = 185
  Top = 175
  BorderIcons = []
  BorderStyle = bsSingle
  Caption = 'Selecionar Valor'
  ClientHeight = 117
  ClientWidth = 375
  Color = 12910591
  ...
  object edtValor: TRxDBLookupCombo
    Left = 3
    Top = 28
    Width = 368
    Height = 23
  ...
  object qryConsulta: TIBQuery
    ...
    object qryConsultaNOME: TIBStringField
      FieldName = 'NOME'
